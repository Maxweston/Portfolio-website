...
$your_email = "contact@maxfweston.co.uk"; // email address to which the form data will be sent
$subject = "Contact Form Message"; // subject of the email that is sent
...
if (empty($com) || !preg_match("/[abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789,!-\/\\:]/", $com) || (strlen($com) > $limit)) { 
